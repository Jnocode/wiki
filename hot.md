...
- 2026-09-16 — [Podcast 現行產線契約](concepts/podcast-current-production-contract.md)
- 2026-09-16 — [Discord AI 日報卡片與安全發布](concepts/discord-ai-digest-presentation.md)
...
- **Podcast 現行產線契約**：定義目前三人主持、音訊製作、品質閘門與 SoundOn 發布的現行規則。（2026-09-16）
- **Discord AI 日報卡片與安全發布**：定義 Discord AI 日報的資料誠信、卡片版型、錯誤隔離與發布 read-back 規則。（2026-09-16）
