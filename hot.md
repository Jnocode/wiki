...
- 2026-09-08 — [Public APIs 免費 API 資源庫 — 資料源目錄索引](concepts/public_apis_free_data_source_index.md)
...
- **Public APIs 免費 API 資源庫 — 資料源目錄索引**：GitHub public-apis/public-apis 免費 API 目錄；工具缺外部資料源時先查分類與官方文件，再決定是否接入。（2026-09-08）
